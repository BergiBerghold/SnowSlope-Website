...
function Loading() {
    ...
    const handleClick = async () => {
        const response = await fetch(ApiUrl, {
            ...
            body: JSON.stringify({
                minimumGradient: data.min,
                maximumGradient: data.max,
                positionLat: data.pos.lat,
                positionLng: data.pos.lng
            })
    ...
    if (data){
        return (
            <div id="background-image-loading">
                ...
                <div className="frame-div">
                    ...
                    <div className="center">
                        <div style={{padding: "10px"}}>
                            Your desired end point has been sent to the server. It will now attempt to calculate
                            a suitable route for skiing. This may take a few seconds
                        </div>
                    </div>
